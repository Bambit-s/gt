<div class="footer">
    <div class="footer_box">
        ...
        <div class="text">
            La producción topiar de la figura por nuestra compañía "el Dragón Verde" es una dirección de la actividad, que nos ocupa con el amor, usando las tecnologías más modernas y los materiales.
        </div>
    </div>
    <div class="footer_box">
        <div class="nav_name">
